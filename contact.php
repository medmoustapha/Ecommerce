		...
		<div class="container">
			<div class="contact-grids">
				...
				<div class="col-md-4 contact-grid text-center animated wow slideInRight" data-wow-delay=".5s">
					<div class="contact-grid3">
						...
						<h4>Email</h4>
						<p><a href="mailto:Wechtetimariem@gmail.com">Wechtetimariem@gmail.com</a><span><a href="mailto:Wechtetimariem@gmail.com">Wechtetimariem@gmail.com</a></span></p>
					</div>
				</div>
			...
			<form action="contact1.php" method="POST">
				<div class="contact-form2">
					...
					<input type="password" name="password" placeholder="motPass" required=""><br>
			...
			<div class="sign-grds">
				...
				<div class="col-md-4 sign-gd-two">
					...
					<ul>
						...
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i>Email : <a href="mailto:Wechtetimariem@gmail.com">Wechtetimariem@gmail.com</a></li>
